...
data class StockState(val sku: SkuReference, val onHand: Int, val reserved: Int, val safety: Int) { val available: Int get() = onHand - reserved }
...
data class MovementState(val id: Long, val sku: SkuReference, val type: String, val delta: Int, val referenceType: String?, val referenceId: UUID?, val memo: String?, val occurredAt: Instant)
