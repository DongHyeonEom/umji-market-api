...
공개 조회는 노출·판매 가능한 상품과 SKU를 반환합니다. 상품의 판매·재고 단위는 SKU입니다.
...
상품 생성 요청은 이미지·옵션·SKU를 함께 포함할 수 있습니다. 별도 SKU 추가 시 옵션값은 해당 상품에 속한 값이어야 합니다. JPA Entity는 catalog persistence adapter 밖으로 전달하지 않습니다.
